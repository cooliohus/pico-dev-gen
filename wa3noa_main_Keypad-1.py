...
# When a key is depressed...
        if key == "*":
            ...
            audio = build_number(digits)
            print("     audio frequency = {} Hz.".format(audio))
            digits = [0]
            utime.sleep(debounce)	# Debounce timer
            
        elif key == "B":
            print("Invoke Bessel setting function")
            print("     deviation frequency = {} Hz.".format(dev))
            audio = dev / 2.405
            ...
            base = build_number(digits)
            print("     carrier frequency = {} Hz.".format(base))
            digits = [0]
            utime.sleep(debounce)	# Debounce timer
            
        elif key == "D":
            print("set Deviation frequency")
            dev = build_number(digits)
            print("     deviation frequency = {} Hz.".format(dev))
            digits = [0]
            utime.sleep(debounce)	# Debounce timer
